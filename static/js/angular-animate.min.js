...
(function (F, x, Oa) {
    ...
    var L = x.noop, za = x.extend, I = x.element, q = x.forEach, Y = x.isArray, M = x.isString, oa = x.isObject,
        pa = x.isUndefined, qa = x.isDefined, Da = x.isFunction, ra = x.isElement, N, sa, W, ta;
    ...
    pa(F.onanimationend) && qa(F.onwebkitanimationend) ?
        (W = "WebkitAnimation", ta = "webkitAnimationEnd animationend") : (W = "animation", ta = "animationend");
    var ka = W + "Delay", ua = W + "Duration", ga = N + "Delay";
    F = N + "Duration";
    var Ma = {
    ...
    }, Na = {transitionDuration: F, transitionDelay: ga, animationDuration: ua, animationDelay: ka};
    x.module("ngAnimate", []).provider("$$body", function () {
        ...
        ["$animateProvider", function (a) {
            ...
            this.$get = ["$$rAF", "$rootScope", "$rootElement", "$document", "$$body", "$$HashMap", "$$animation", "$$AnimateRunner", "$templateRequest", "$$jqLite", "$$forceReflow", function (d, y, v, z, l, s, O, x, t, la, E) {
                ...
                function u(a, g, m) {
                    ...
                    if (!C(k)) return w(), e;
                    var l = 0 <= ["enter", "move", "leave"].indexOf(g), u = !H || U.get(B), k = !u && A.get(B) || {},
                        v = !!k.state;
                    u || v && 1 == k.state || (u = !p(a, h, g));
                    if (u) return w(),
                        e;
                    l && J(a);
                    h = {structural: l, element: a, event: g, close: w, options: m, runner: e};
                    if (v) {
                        if (b("skip", a, h, k)) {
                        ...
                        if (b("cancel", a, h, k)) if (2 === k.state) k.runner.end(); else if (k.structural) k.close(); else return R(a, k.options, h.options), k.runner; else if (b("join", a, h, k)) if (2 === k.state) R(a, m, {}); else return Ka(a, l ? g : null, m), g = h.event = k.event, m = R(a, k.options, h.options), k.runner
                    } else R(a, m, {});
                    (v = h.structural) || (v = "animate" === h.event && 0 < Object.keys(h.options.to ||
                        {}).length || c(h.options));
                    if (!v) return w(), f(a), e;
                    var t = (k.counter || 0) + 1;
                    h.counter = t;
                ...
                function J(a) {
                    ...
                    q(a, function (a) {
                        var b = parseInt(a.getAttribute("data-ng-animate")), c = A.get(a);
                        switch (b) {
                            case 2:
                                c.runner.end();
                            case 1:
                ...
                var A = new s, U = new s, H = null, g = y.$watch(function () {
                ...
                }), w = {}, k = a.classNameFilter(), C = k ? function (a) {
                    return k.test(a)
                } : function () {
                    return !0
                }, Ea = Q(la);
        ...
        this.$get = ["$$jqLite", "$rootScope", "$injector", "$$AnimateRunner", "$$HashMap", "$$rAFScheduler", function (a, e, y, v, z, l) {
            function s(a) {
                ...
                var c = {children: []}, d, e = new z;
                for (d = 0; d < a.length; d++) {
                    var l = a[d];
                    e.put(l.domNode, a[d] = {domNode: l.domNode, fn: l.fn, children: []})
                }
            ...
            return function (t, z, E) {
                ...
                function S(a) {
                    var b = [], c = {};
                    q(a, function (a, g) {
                        var d = G(a.element), f = 0 <= ["enter", "move"].indexOf(a.event), d = a.structural ? h(d) : [];
                        if (d.length) {
                            var e = f ? "to" : "from";
                            q(d, function (a) {
                                var b = a.getAttribute("ng-animate-ref");
                                c[b] = c[b] || {};
                                c[b][e] = {animationID: g, element: I(a)}
                            })
                        } else b.push(a)
                    });
                    var d = {}, f = {};
                    q(c, function (c, e) {
                        var h = c.from, r = c.to;
                        if (h && r) {
                            var J = a[h.animationID], k = a[r.animationID], B = h.animationID.toString();
                            if (!f[B]) {
                                var l = f[B] = {
                                    structural: !0, beforeStart: function () {
                                        ...
                                        J.close();
                                        k.close()
                                    }, classes: u(J.classes, k.classes), from: J, to: k, anchors: []
                                };
                                l.classes.length ? b.push(l) : (b.push(J), b.push(k))
                            }
                            f[B].anchors.push({out: h.element, "in": r.element})
                ...
                E = ia(E);
                var r = 0 <= ["enter", "move", "leave"].indexOf(z), A = new v({
                    end: function () {
                        p()
                    }, cancel: function () {
                        p(!0)
                ...
                var U = wa(t.attr("class"), wa(E.addClass, E.removeClass)), H = E.tempClasses;
                H && (U += " " + H, E.tempClasses = null);
                O.push({
                    element: t, classes: U, event: z,
                    structural: r, options: E, beforeStart: function () {
        ...
        this.$get = ["$window", "$$jqLite", "$$AnimateRunner", "$timeout", "$$forceReflow", "$sniffer", "$$rAFScheduler", "$animate", function (a, e, y, v, z, l, s, O) {
            ...
            function t(h, f, l, p) {
                var r;
                0 < b.count(l) && (r = c.get(l), r || (f = V(f, "-stagger"), e.addClass(h, f), r = Aa(a, h, p), r.animationDuration = Math.max(r.animationDuration,
                    0), r.transitionDuration = Math.max(r.transitionDuration, 0), e.removeClass(h, f), c.put(l, r)));
                return r || {}
            }
            ...
            function E(c, f, h) {
                ...
                c.maxDuration = Math.max(c.animationDuration * c.animationIterationCount,
            ...
            return function (a, c) {
                ...
                function H() {
                    ...
                    if (!s) if (g.parentNode) {
                        var H, m = [], k = function (a) {
                            if (S) z && a && (z = !1, r()); else if (z = !a, D.animationDuration) if (a = ma(g, z), z) w.push(a); else {
                                var b = w, c = b.indexOf(a);
                                0 <= a && b.splice(c, 1)
                            }
                        }, p = 0 < Z && (D.transitionDuration &&
                            0 === T.transitionDuration || D.animationDuration && 0 === T.animationDuration) && Math.max(T.animationDelay, T.transitionDelay);
                ...
                c.transitionStyle && (C =
                    [N, c.transitionStyle], fa(g, C), w.push(C));
                ...
                n.applyTransitionDuration =
                    k && (n.hasTransitions && !n.hasTransitionAll || n.hasAnimations && !n.hasTransitions);
                ...
                if (n.applyTransitionDuration || n.applyAnimationDuration) K = c.duration ? parseFloat(c.duration) : K, n.applyTransitionDuration && (n.hasTransitions = !0, D.transitionDuration = K, C = 0 < g.style[N + "Property"].length, w.push(Ba(K,
                    C))), n.applyAnimationDuration && (n.hasAnimations = !0, D.animationDuration = K, w.push([ua, K + "s"]));
                ...
                M = 1E3 * I;
                Q = 1E3 * K;
                c.skipBlocking || (n.blockTransition = 0 < D.transitionDuration, n.blockKeyframeAnimation = 0 < D.animationDuration && 0 < T.animationDelay &&
                ...
                return {
                    $$willAnimate: !0, end: d, start: function () {
                        if (!s) return F = {end: d, cancel: p, resume: null, pause: null}, m = new y(F), la(H), m
                    }
                }
            }
        }]
        ...
        this.$get = ["$animateCss", "$rootScope", "$$AnimateRunner", "$rootElement", "$$body", "$sniffer", "$$jqLite", function (a, c, d, e, y, v, z) {
            ...
            function O(c, e, u) {
                function v(a) {
                    var b = {}, c = G(a).getBoundingClientRect();
                ...
                function f() {
                    var c = l(u.attr("class") || ""), d = s(c, r), c = s(r, c), d = a(p, {
                        to: v(u),
                ...
                var p = I(G(e).cloneNode(!0)), r = l(p.attr("class") || "");
                ...
                var A;
                c = function () {
                    var c = a(p, {addClass: "ng-anchor-out", delay: !0, from: v(e)});
            ...
            "$$AnimateRunner", "$$jqLite", function (b, c, d) {
                function e(c) {
                    ...
                    for (var d = [], e = {}, s = 0; s < c.length; s++) {
                        var q = c[s], y = a.$$registeredAnimations[q];
                ...
                return function (a, b, d, s) {
                    ...
                    function F(a, b, d, e, f) {
                        ...
                        b.push(e);
                        if (a = a.apply(a, b)) if (Da(a.start) &&
                        (a = a.start()), a instanceof c) a.done(f); else if (Da(a)) return a;
                        return L
                    }
                    ...
                    function G(a, b, d, e, f) {
                        ...
                        if (0 === g.length) {
                            var h, k;
                            "beforeSetClass" === f ? (h = t(a, "removeClass", d, e, "beforeRemoveClass"), k = t(a, "addClass", d, e, "beforeAddClass")) : "setClass" ===
                                f && (h = t(a, "removeClass", d, e, "removeClass"), k = t(a, "addClass", d, e, "addClass"));
                            h && (g = g.concat(h));
                            k && (g = g.concat(k))
                        }
                    ...
                    var E = s.addClass, h = s.removeClass, I = e(d), u, J;
                    if (I.length) {
                        var f, B;
                        "leave" ==
                        b ? (B = "leave", f = "afterLeave") : (B = "before" + b.charAt(0).toUpperCase() + b.substr(1), f = b);
